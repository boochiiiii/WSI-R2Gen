...
def parse_agrs():
    ...
    # Model settings (for visual extractor, kept for R2Gen compatibility)
    parser.add_argument('--visual_extractor', type=str, default='resnet101', help='the visual extractor to be used.')
    parser.add_argument('--visual_extractor_pretrained', type=bool, default=False, help='whether to load pretrained visual extractor')
    # Relational Memory (R2Gen)
    # Relational Memory (R2Gen)
    parser.add_argument('--rm_num_slots', type=int, default=3, help='the number of memory slots.')
    parser.add_argument('--rm_num_heads', type=int, default=4, help='the number of heads in relational memory.')
    parser.add_argument('--rm_d_model', type=int, default=512, help='the dimension of relational memory.')
    parser.add_argument('--disable_rm', type=bool, default=False, help='disable relational memory (reduce memory usage).')
